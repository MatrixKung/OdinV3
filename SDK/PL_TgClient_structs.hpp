...
#define CONST_UIPROFILE2023_LOADOUT_CATEGORIES                   9
...
#define CONST_UIPROFILE2023_HISTORY_ROWS                         8
...
#define CONST_UIHUDCENTER_ICONS_TICKS                            6
...
#define CONST_UIPROFILE2023_AWARD_ENTRIES                        8
#define CONST_UIPROFILE2023_AWARD_GOALS                          10
#define CONST_UIPROFILE2023_ACCOUNTBOOSTTOOLTIP_COUNT            4
...
#define CONST_UISCENE_UIPROFILELEGACY_MATCHSTATSPOPUP_TABS       2
...
// Enum TgClient.UIComponent_KasumiCurseCharges.CurseChargesAnimEvent
enum class ECurseChargesAnimEvent : uint8_t
{
	CurseChargesAE_Show            = 0,
	CurseChargesAE_Hide            = 1,
	CurseChargesAE_AnimZero        = 2,
	CurseChargesAE_AnimOne         = 3,
	CurseChargesAE_AnimTwo         = 4,
	CurseChargesAE_MAX             = 5
};


// Enum TgClient.UIComponent_KasumiCurseIcon.CurseIconAnimEvent
enum class ECurseIconAnimEvent : uint8_t
{
	CurseIconAE_Show               = 0,
	CurseIconAE_Hide               = 1,
	CurseIconAE_MAX                = 2
...
// Enum TgClient.UIProfileLegacy.EHistoryResult
...
// Enum TgClient.UIProfileLegacy.PROFILESTATE
...
// Enum TgClient.UIProfileLegacy.LoadoutState
...
{
	int                                                nId;                                                      // 0x0000(0x0004)
	int                                                nIconTintedColorFrame;                                    // 0x0004(0x0004)
	unsigned long                                      bIsActive : 1;                                            // 0x0008(0x0004)
	unsigned long                                      bInRange : 1;                                             // 0x0008(0x0004)
	struct FVector                                     vProjLoc;                                                 // 0x000C(0x000C)
	float                                              fScaleMult;                                               // 0x0018(0x0004)
	class UGFxObject*                                  pObj;                                                     // 0x001C(0x0008)
	class UGFxObject*                                  pPointer;                                                 // 0x0024(0x0008)
	class UGFxObject*                                  pIconTinted;                                              // 0x002C(0x0008)
	class UGFxObject*                                  pCurrentIcon;                                             // 0x0034(0x0008)
	class UGFxObject*                                  pIcons[0x6];                                              // 0x003C(0x0008)
	class UGFxObject*                                  pArrow;                                                   // 0x006C(0x0008)
};
...
struct FUITargetableOverlay
{
	...
	class UGFxObject*                                  pCurrentIcon;                                             // 0x0064(0x0008)
...
struct FUIPlayerOverlay : public FUITargetableOverlay
{
	...
	class UUIComponent_KasumiCurseCharges*             pCurseCharges;                                            // 0x0114(0x0008)
	class UUIComponent_TelepunchTarget*                pTelepunch;                                               // 0x011C(0x0008)
	class UUIComponent_MojiCounter*                    pMojiCounter;                                             // 0x0124(0x0008)
	class UUIComponent_CorrupterCorruptionUI*          pCorrupterUI;                                             // 0x012C(0x0008)
	float                                              fHideTimer;                                               // 0x0134(0x0004)
	unsigned long                                      bInParty : 1;                                             // 0x0138(0x0004)
	TEnumAsByte<EPlayerIconState>                      eIconState;                                               // 0x013C(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x013D(0x0003) MISSED OFFSET
	unsigned long                                      bShowPlayerName : 1;                                      // 0x0140(0x0004)
};
...
{
	class UGFxObject*                                  pLeftArc;                                                 // 0x0084(0x0008)
	class UGFxObject*                                  pRightArc;                                                // 0x008C(0x0008)
	class UGFxObject*                                  pTopArc;                                                  // 0x0094(0x0008)
	class UGFxObject*                                  pPointer;                                                 // 0x009C(0x0008)
	class UGFxObject*                                  pDynamicIcon;                                             // 0x00A4(0x0008)
	class UGFxObject*                                  pDynamicIconTexture;                                      // 0x00AC(0x0008)
	class UGFxObject*                                  pBarrageFrame;                                            // 0x00B4(0x0008)
	class UGFxObject*                                  pBarrageMeter;                                            // 0x00BC(0x0008)
	class UGFxObject*                                  pIconParent;                                              // 0x00C4(0x0008)
	class UGFxObject*                                  pIcons[0x6];                                              // 0x00CC(0x0008)
	float                                              fAnimTime;                                                // 0x00FC(0x0004)
	TEnumAsByte<EDeployableOverlayInternalState>       eState;                                                   // 0x0100(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0101(0x0003) MISSED OFFSET
	float                                              fDamagePulseTimer;                                        // 0x0104(0x0004)
	int                                                nCurrentIcon;                                             // 0x0108(0x0004)
	int                                                nDynamicIconProfileId;                                    // 0x010C(0x0004)
	int                                                nDynamicIconSkinId;                                       // 0x0110(0x0004)
	int                                                nDeployableOverlayDisplayMask;                            // 0x0114(0x0004)
	int                                                nIconsParentColorFrame;                                   // 0x0118(0x0004)
};
