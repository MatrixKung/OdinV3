...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class OnlineSubsystemDiscord.OnlineGameInterfaceDiscord"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class OnlineSubsystemDiscord.OnlineSubsystemDiscord"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class OnlineSubsystemDiscord.OnlineMarketplaceInterfaceDiscord"));
		return ptr;
	}
