...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class WinDrv.FacebookWindows"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class WinDrv.HttpRequestWindows"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class WinDrv.HttpResponseWindows"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class WinDrv.SwrveAnalyticsWindows"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class WinDrv.WindowsClient"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class WinDrv.XnaForceFeedbackManager"));
		return ptr;
	}
