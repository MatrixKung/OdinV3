...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class OnlineSubsystemPC.OnlineSubsystemPC"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class OnlineSubsystemPC.OnlineVoiceInterfacePC"));
		return ptr;
	}
