...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class OnlineSubsystemEpic.OnlineGameInterfaceEpic"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class OnlineSubsystemEpic.OnlineSubsystemEpic"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class OnlineSubsystemEpic.OnlineMarketplaceInterfaceEpic"));
		return ptr;
	}
