...
{
    //static uintptr_t TEB = StealTLS();
    unsigned int tlsidx = *(unsigned int*)((uintptr_t)moduleBase + 0x43925A4);
    return *(uintptr_t*)(*(uintptr_t*)(TEB + (__int64)8 * tlsidx) + (__int64)8 * (index & 0x1FF) + 48);
}